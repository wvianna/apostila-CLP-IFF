...
\usepackage{array}
% As tabelas usam colunas p{} com largura declarada em cm. Cada coluna acrescenta
% 2\tabcolsep alem da largura declarada: com o padrao de 6pt, uma tabela de 3
% colunas "p{3.0} p{5.6} p{6.0}" fica 12pt mais larga do que a soma dos cm e
% transborda a mancha (Overfull \hbox). Com 3pt a folga entra na conta.
...
\newcommand{\obraCursoEng}{Engenharia de Controle e Automação}
\newcommand{\obraLicenca}{Creative Commons Atribuição–CompartilhaIgual 4.0 Internacional (CC BY-SA 4.0)}
...
\newcommand{\obraRevisor}{M.Sc. Karina Terra de Souza}
...
% ============================================================================
%  Crédito de fonte de figura de terceiro
%  Usar logo após \end{figure}; fica FORA da legenda para não entrar na lista
%  de figuras. Ex.: \fontefig{Imagem obtida na internet...}
% ============================================================================
\newcommand{\fontefig}[1]{%
  \par\smallskip{\centering\footnotesize\itshape Fonte: #1\par}}
...
\begin{center}
  ...
  {\small Material didático elaborado para o curso de \obraCursoEng\ e para o
   \obraCurso.}\\[2cm]
\end{center}
\begin{flushright}
...
\vfill
{\footnotesize
  \noindent\textbf{Licença de uso.} Esta obra é distribuída sob a licença
  \emph{\obraLicenca}. É permitido copiar, redistribuir, adaptar e usar comercialmente o
  material, desde que seja atribuído o crédito aos autores e as obras derivadas sejam
  distribuídas sob a mesma licença. Texto completo da licença:\
  \url{https://creativecommons.org/licenses/by-sa/4.0/legalcode.pt}.\par
}
\vspace{1cm}
\clearpage
